...
dt_color_checker_t xrite_24_2000 = { .name = "Xrite ColorChecker 24 before 2014",
                                    ...
                                    .black = 23,
                                    .values = {
                                              { "A1", { 39.22,   14.24,   13.46 }, { 0.087, 0.125}},
                                              { "A2", { 66.01,   19.95,   16.55 }, { 0.250, 0.125}},
                                              { "A3", { 53.16,   -3.79,  -24.75 }, { 0.417, 0.125}},
                                              { "A4", { 45.82,  -13.58,   21.66 }, { 0.584, 0.125}},
                                              { "A5", { 58.55,   11.35,  -27.08 }, { 0.751, 0.125}},
                                              { "A6", { 75.08,  -31.60,   -1.81 }, { 0.918, 0.125}},
                                              { "B1", { 66.58,   37.13,   57.97 }, { 0.087, 0.375}},
                                              { "B2", { 45.11,   11.40,  -46.21 }, { 0.250, 0.375}},
                                              { "B3", { 52.47,   49.65,   14.69 }, { 0.417, 0.375}},
                                              { "B4", { 33.22,   23.53,  -23.13 }, { 0.584, 0.375}},
                                              { "B5", { 76.87,  -23.49,   59.47 }, { 0.751, 0.375}},
                                              { "B6", { 75.13,   18.28,   70.63 }, { 0.918, 0.375}},
                                              { "C1", { 30.03,   16.23,  -52.36 }, { 0.087, 0.625}},
                                              { "C2", { 58.29,  -40.80,   31.29 }, { 0.250, 0.625}},
                                              { "C3", { 43.98,   53.69,   27.86 }, { 0.417, 0.625}},
                                              { "C4", { 85.37,    1.58,   79.59 }, { 0.584, 0.625}},
                                              { "C5", { 53.84,   52.99,  -15.68 }, { 0.751, 0.625}},
                                              { "C6", { 53.26,  -30.68,  -29.74 }, { 0.918, 0.625}},
                                              { "D1", { 99.07,   -1.10,    0.88 }, { 0.087, 0.875}},
                                              { "D2", { 85.39,   -0.69,   -1.82 }, { 0.250, 0.875}},
                                              { "D3", { 71.19,   -0.77,   -1.26 }, { 0.417, 0.875}},
                                              { "D4", { 52.90,    0.32,   -1.32 }, { 0.584, 0.875}},
                                              { "D5", { 38.85,   -0.82,   -1.57 }, { 0.751, 0.875}},
                                              { "D6", { 19.04,   -0.05,    1.99 }, { 0.918, 0.875}} } };
