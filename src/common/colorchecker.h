...
dt_color_checker_t xrite_24_2000 = { .name = "Xrite ColorChecker 24 before 2014",
                                    ...
                                    .black = 23,
                                    .values = {
                                              { "A1", { 38.77,  12.74,  12.77 }, { 0.087, 0.125}},
                                              { "A2", { 65.42,  17.79,   15.66  }, { 0.250, 0.125}},
                                              { "A3", { 52.65, -0.62,  -23.99 }, { 0.417, 0.125}},
                                              { "A4", { 45.84, -15.17,  22.28 }, { 0.584, 0.125}},
                                              { "A5", { 58.75,  14.46, -27.11 }, { 0.751, 0.125}},
                                              { "A6", { 75.71, -30.75,  -0.03 }, { 0.918, 0.125}},
                                              { "B1", { 65.25,  33.82,  56.13 }, { 0.087, 0.375}},
                                              { "B2", { 42.77,   18.32,  -45.69 }, { 0.250, 0.375}},
                                              { "B3", { 51.16,  48.13,  11.98 }, { 0.417, 0.375}},
                                              { "B4", { 33.07,  26.37, -24.1 }, { 0.584, 0.375}},
                                              { "B5", { 76.77, -27.55,  60.81 }, { 0.751, 0.375}},
                                              { "B6", { 74.18,  13.44,  70.26 }, { 0.918, 0.375}},
                                              { "C1", { 30.85,  24.52, -51.52 }, { 0.087, 0.625}},
                                              { "C2", { 58.7, -42.89,  33.21  }, { 0.250, 0.625}},
                                              { "C3", { 42.43,  51.48,  24.87  }, { 0.417, 0.625}},
                                              { "C4", { 84.7,  -4.01,  80.13 }, { 0.584, 0.625}},
                                              { "C5", { 52.82,  54.44, -18.51 }, { 0.751, 0.625}},
                                              { "C6", { 54.39, -26.02, -27.37 }, { 0.918, 0.625}},
                                              { "D1", { 99.08,  -1.15,   0.95 }, { 0.087, 0.875}},
                                              { "D2", { 85.43,  -0.58,  -1.68 }, { 0.250, 0.875}},
                                              { "D3", { 71.23,  -0.77,  -1.09 }, { 0.417, 0.875}},
                                              { "D4", { 52.92,  0.27,  -1.19  }, { 0.584, 0.875}},
                                              { "D5", { 38.9,  -0.75,  -1.44 }, { 0.751, 0.875}},
                                              { "D6", { 19.01,  -0.26,  1.99 }, { 0.918, 0.875}} } };
